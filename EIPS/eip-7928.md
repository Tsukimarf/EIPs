...
- Transaction senders (gas + value), expect for simple ETH transfers
- Recipients
...
Simple ETH transfers with a gas limit and usage of 21,000 MUST NOT contribute to a balance change of the sender and recipient. For them, all information required is statically available through the block.
